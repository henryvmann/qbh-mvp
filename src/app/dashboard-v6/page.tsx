...
function ArcGauge({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <span
        className="mt-1 text-sm text-center max-w-[140px]"
...
function GaugeSection({ items }: { items: ActionItem[] }) {
  // Care Score: up-to-date + upcoming / total
  ...
  // Inverse fill: 0 days = 100%, 30+ days = ~0%
  ...
  // Overdue arc: 0 months = 0%, 12+ months = 100%
  const overdueValue = worstOverdue
    ? Math.min(100, (worstOverdue.months / 12) * 100)
    : 0;
  const overdueColor =
    worstOverdue && worstOverdue.months > 6 ? P.coral : P.lime;

  // Care score gradient: use olive at midrange
  const careColor =
  ...
  return (
    <div className="mx-4 mb-6">
      <div className="flex gap-4 overflow-x-auto pb-2 md:grid md:grid-cols-3 md:overflow-visible">
        {/* Gauge 1: Care Score */}
        <div
          className="flex min-w-[200px] flex-1 flex-col items-center p-6"
          style={glassCard}
        >
          <ArcGauge
            value={careScore}
        ...
        >
          <ArcGauge
            value={nextValue}
            label="Days to next appointment"
...
function WeekCalendarStrip() {
  ...
  return (
    <div className="mx-4 mb-6 p-5" style={glassCard}>
...
function OverdueCard({
  ...
  return (
    <div className="mx-4 p-6" style={glassCard}>
...
function ActionCards({
  ...
  return (
    <section className="space-y-4">
      {cards.length === 0 ? (
        <div className="mx-4 p-8 text-center" style={glassCard}>
          <p
            className="text-lg"
            style={{ color: "rgba(240,237,232,0.5)" }}
          >
...
function LoadingSkeleton() {
  return (
    <main
      className="min-h-screen px-4 pt-8 md:px-8"
      style={{
        background:
    ...
    >
      <div className="space-y-6 pt-16">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="mx-4 animate-pulse p-8"
            style={glassCard}
          >
            <div
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="px-6 pt-8 pb-8 md:px-8">
          ...
          <h1
            className="mt-2 text-4xl font-light leading-tight md:text-5xl"
            style={{ color: P.cream }}
          >
