      ...
      >
        <div>
          ...
          >
            ...
            your appointments, and follows up on the details. So you don’t
            have to.
          </p>
          <div
            style={{
    ...
    >
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ margin: 0 }}>
            Built from the inside out by a therapist who knows what it’s like to navigate this
  ...
  const steps = [
    {
      num: "01",
      title: "Connect once.",
      body: "Kate learns your care team from your booked appointments and copay history. No forms, no manual entry. She’s working on day one.",
    ...
    },
    {
      num: "03",
      title: "Stay on track.",
      body: "Your dashboard shows what’s done, what’s next, and your care coordination score. So you always know what’s coming up and what’s already taken care of.",
...
function TrustBand() {
  const pillars = [
    ...
    },
    {
      ...
      body: "Built by a clinician who’s lived this. For herself and her family.",
    },
    {
      icon: <SparkleIcon color={T.electric} />,
    ...
    >
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          ...
          When you’re ready, plans start at $24/mo.
        </p>
        <Link
          href="/onboarding"
          style={{
