...
import { getSpecialtyColor, SPECIALTY_COLORS } from "../../lib/qbh/provider-utils";
...
export default function ProvidersHubC() {
  ...
  if (selected) {
    const colors = getSpecialtyColor(selected.provider);
  ...
  return (
    <PageShell>
      ...
      <div className="mt-6 text-[10px] font-bold uppercase tracking-[0.15em] text-[#7A7F8A] mb-1">
        Option C: Individual Provider Hubs
      </div>
      ...
      <div className="mt-6 text-center">
        ...
        {" · "}
        <a href="/providers-hub-a" className="text-xs text-[#7A7F8A] underline">Compare with Option A</a>
      </div>
    </PageShell>
  );
}
