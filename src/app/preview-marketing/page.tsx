...
/**
 * /preview-marketing — Quarterback Health public landing redesign.
 *
 * v5 brand language, dashboard-first proof. Sections:
 *   1. Sticky top nav (wordmark + Sign in / Start free)
 *   2. Hero — headline, subhead, CTAs, embedded phone mock of the v5
 *      light-mode home (Kate active + Health organized + Next Step).
 *   3. How it works — 3 steps with icon tiles.
 *   4. Trust band — 4 pillars (You stay in control / Expert support /
 *      Fewer headaches / Better outcomes).
 *   5. Pricing teaser.
 *   6. Footer.
 *
 * Static page. No auth, no API. Once approved, contents move into
 * the actual / route.
 */
...
// ─────────────────────────────────────────────────────────────────
// Phone mock — simplified v5 home, marketing-only
// ─────────────────────────────────────────────────────────────────
