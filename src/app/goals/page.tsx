...
export default function GoalsPage() {
  ...
  async function handleGetSuggestions() {
    ...
    try {
      // Empty input → "I don't know where to start, suggest based on
      // my care state." API treats it as a request for general
      // proactive suggestions from the user's existing data.
      const body = input
        ? { input }
        : { input: "general health goals based on my care state" };
