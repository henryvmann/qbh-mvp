...
const PALETTE: Record<string, { bg: string; border: string; accent: string; label: string }> = {
  pcp:        { bg: "#E8EDE8", border: "#C8D8C8", accent: "#4A6A4A", label: "Primary Care" },
  dentist:    { bg: "#E0E8EE", border: "#B8CCE0", accent: "#3A5A7A", label: "Dentist" },
  therapist:  { bg: "#EAE0EA", border: "#D0B8D0", accent: "#6A4A6A", label: "Therapist" },
  eye:        { bg: "#EDE8D8", border: "#D8D0B0", accent: "#6A5A2A", label: "Eye Care" },
  dermatology:{ bg: "#EDE0D8", border: "#D8C8B0", accent: "#7A4A3A", label: "Dermatology" },
  obgyn:      { bg: "#EDE0E4", border: "#D8B8C8", accent: "#7A3A5A", label: "OB/GYN" },
  specialist: { bg: "#E0E4EA", border: "#B8C8D8", accent: "#3A4A6A", label: "Specialist" },
  pharmacy:   { bg: "#E8E8E8", border: "#D0D0D0", accent: "#6A6A6A", label: "Pharmacy" },
  default:    { bg: "#E8EAE8", border: "#D0D4D0", accent: "#4A5A4A", label: "Provider" },
};
...
export default function ProvidersHubC1() {
