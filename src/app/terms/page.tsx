export const metadata = {
  title: "Terms of Service — Quarterback Health",
        ...
        <div className="space-y-8 text-[#3A3F4B] text-sm leading-relaxed">
          <section>
            ...
            <p>
              ...
              18 years old to use Quarterback Health.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Kate, can chat with you about your care, call provider offices on your behalf, and suggest
          ...
          <section>
            ...
            <p>
              ...
              professional. Any suggestions, summaries, or recommendations provided through the Service
              are for organizational and administrative purposes only. Always consult qualified healthcare
              providers for medical decisions. Do not disregard or delay seeking professional medical
              advice based on anything provided through this Service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              <li>Kate will call healthcare provider offices on your behalf using AI voice technology</li>
              <li>Calls are placed during business hours (9 AM &ndash; 6 PM ET, Monday &ndash; Friday) only</li>
              <li>Kate will identify herself and state she is calling on your behalf</li>
              <li>Call outcomes depend on provider office cooperation and availability &mdash; we cannot guarantee appointments will be booked</li>
              <li>You are responsible for confirming any appointments discussed during AI calls</li>
              <li>Call transcripts and summaries will be stored in your account</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              registration and to update it as needed. You may delete your account at any time from
              the Account page, which will permanently remove all your data.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              to access the specific data described during the connection process. You can disconnect
              these services at any time. Your use of third-party services is also subject to their
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>Use the Service to harass healthcare providers or their staff</li>
              <li>Reverse engineer, decompile, or disassemble any part of the Service</li>
              <li>Use the Service on behalf of others without their knowledge and consent</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              or that you are their legal guardian or authorized representative.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              generated by AI may not be perfectly accurate &mdash; always verify important information
          ...
          <section>
            ...
            <p>
              ...
              a limited, non-exclusive, non-transferable license to use the Service for personal,
              non-commercial healthcare coordination purposes.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              of the Service. This includes, without limitation, damages arising from missed
              appointments, incorrect AI summaries, failed phone calls, or reliance on any information
              provided through the Service. Our total liability shall not exceed the amount you paid
          ...
          <section>
            ...
            <p>
              ...
              or that AI-generated content will be accurate or complete. We do not guarantee that any
              appointment will be successfully booked or that provider information is current.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              any time by using the &quot;Delete my account&quot; feature. Upon termination, your data will be
              permanently deleted.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              disagree with updated Terms, you should stop using the Service and delete your account.
            </p>
          </section>
